                ...
                <div className='bg-[#FAFAFB] w-full flex justify-center gap-12'>
                    <div>
                        <div className='flex flex-col rounded-2xl my-4 mx-auto md:w-[900px] bg-white border'>
                            <div className={`bg-[url('/assets/images/licences/training-bg.png')] bg-cover bg-center h-[500px] rounded-t-2xl relative`}>
                                <img src="/assets/images/licences/training-profile.png" alt="Profile picture" className='rounded-full border-neutral-300 border w-[150px] h-[150px] absolute left-4 bottom-4' />
                            </div>
                            <div className='flex justify-between px-8 py-6'>
                                <div className='flex flex-col gap-3'>
                                    <h2 className='text-2xl h-bold'>Latte Art</h2>
                                    ...
                                    <div className={`flex gap-2 pt-4`}>
                                        ...
                                        <button className='h-full flex text-[#326B88] border-[#326B88] border rounded-md px-3 py-2 duration-500 cursor-pointer fav-button'>
                                            <svg width="25" height="25" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='pr-1'>
                                                <path d="M26.5834 7.51661C24.0274 4.96061 19.8826 4.96061 17.3266 7.51661C17.0114 7.83181 16.7378 8.17181 16.5002 8.52861C16.2626 8.17181 15.989 7.83181 15.6738 7.51741C13.1178 4.96141 8.973 4.96141 6.417 7.51741C3.861 10.0734 3.861 14.2182 6.417 16.7742L16.5002 26.8566L26.5834 16.7734C29.1394 14.2174 29.1394 10.0734 26.5834 7.51661Z" stroke="#326B88" strokeWidth="1.92" stroke-miterlimit="10" stroke-linecap="square"/>
                                            </svg>
                                            Add to Saved List
                                        </button>
                                    </div>
                                ...
                                <div className='flex flex-col text-right gap-4'>
                                    ...
                                    <div>
                                        <h2 className='text-xl'>Courses Available</h2>
                                        <p>13 Courses</p>
                                    </div>
                                    <div>
                            ...
                            <div className='flex flex-col px-8 pb-6'>
                                <h2 className='text-xl h-bold'>About the Course</h2>
                                <p>
                                    Latte art is one of the most enjoyable and rewarding skills to master as a barista. This course will focus purely on refininf your milk and latter art skills. Desings covered will include hearts, tulips and rosettas. This is a fun and casual course for those with at least basice experience on the coffee machine.
                                </p>
                                <p className='mt-3'>
                                    If you don't have much experience and are not comfortable steaming milk, we highly recommend you complete the Basic Espresso course first. This will teach you how to steam and split milk while showing you the key fundamentals of latter art.
                                </p>
                                <p className='mt-3'>Clasess are limited to 4 people.</p>
                            </div>
                        </div>
                        <div className='flex flex-col rounded-2xl my-4 mx-auto w-[900px] bg-white px-8 py-6 border'>
                            <h2 className='text-2xl h-bold'>The Course in Images</h2>
                            <div className='flex gap-4 mt-4'>
                                <Image src={'/assets/images/licences/licences-2.png'} alt='' width={200} height={200}/>
                                <Image src={'/assets/images/licences/licences-10.png'} alt='' width={200} height={200}/>
                                <Image src={'/assets/images/licences/licences-11.png'} alt='' width={200} height={200}/>
                                <Image src={'/assets/images/licences/licences-12.png'} alt='' width={200} height={200}/>
                            </div>
                        </div>
                    </div>
