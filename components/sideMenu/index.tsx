    ...
    return(
        <div className={`duration-500 top-0 right-0 md:w-80 w-screen fixed h-screen
         ...
         ${ sideMenu ? 'translate-x-0 opacity-100' : 'translate-x-full'}`}>
            ...
            ">
                <li className="my-5  text-lg cursor-pointer duration-500 rounded-xl py-2 px-8 hover:underline"><a href="/" onClick={closeSideMenu}>Home</a></li>
                <li className="my-5  text-lg cursor-pointer duration-500 rounded-xl py-2 px-8 hover:underline"><a href="#about" onClick={closeSideMenu}>About</a></li>
                <li className="my-5  text-lg cursor-pointer duration-500 rounded-xl py-2 px-8 hover:underline"><a href="#contact" onClick={closeSideMenu}>Contact</a></li>
                <li className='mx-4'>
