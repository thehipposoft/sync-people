...
const How = () => {
  return (
    <div className='md:h-screen how flex md:pl-20 p-6 md:p-0' id='how'>
      <div className='flex items-center 2xl:justify-between max-w-[1350px] mx-auto flex-wrap'>
        <div className='md:w-[35%] flex flex-col justify-center'>
          ...
          <p className='text-white md:pt-4 mb-4 md:mb-0'>
          ...
          <Link href={'/worker-sign-up'} className='flex mb-4 md:mb-0'>
