        ...
        <div className='max-w-[1250px] mx-auto px-8 md:px-0 py-6 md:py-0 md:h-[90vh] md:gap-32 grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
            ...
            >
                <Image
                    ...
                    fill priority
                />
                <div className='w-full h-full bg-gradient-to-bl from-[#3EC1AA] via-[#7087E5] to-secondary opacity-80 duration-700 group-hover:opacity-100 rounded-3xl md:rounded-br-[8rem] rounded-br-[5rem] absolute z-10' />
