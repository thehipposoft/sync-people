...
const Categories = () => {
  return (
        <div className='py-12'>
            <h2 className='font-semibold text-4xl px-6 md:px-0 container tracking-tight md:tracking-normal'>
            ...
            <div className='flex justify-center py-10 px-5 flex-wrap gap-5'>
                <div className='grid grid-cols-1 md:grid-cols-2 md:w-[600px] gap-5'>
                    <div className='flex flex-col w-[280px] md:h-[600px] col-span-1 rounded-t-full'>
                        <Link
                            href={ROUTES.CATEGORIES_HOSPITALITY}
                            className='group'
                        >
                            ...
                            <div className='relative w-[280px] h-[320px] hidden md:block'>
                                <Image
                                    src={'/assets/images/categories/cat-1.webp'}
                                    alt='Hospitality jobs in Australia with Insyncx'
                                    width={600}
                                    height={600}
                                    className='object-cover rounded-bl-[150px] w-full h-full' />
                            </div>
                        </Link>
                    </div>
                    <div className='flex flex-col w-[280px] md:h-[600px] col-span-1'>
                        <Link
                            href={ROUTES.CATEGORIES_WAREHOUSING}
                            className='group flex flex-col gap-5'
                        >
                            <div className={`relative h-[280px] w-[280px] hidden md:block `}>
                                <Image
                                    src={'/assets/images/categories/categories-2.jpg'}
                                    alt='Warehousing jobs in Australia with Insyncx'
                                    width={600}
                                    height={600}
                                    className='object-cover rounded-full rounded-bl-none w-full h-full'
                                />
                            </div>
                            <div className='bg-light-green relative rounded-full rounded-tr-none h-[300px] overflow-hidden flex flex-col justify-center pl-8 duration-500 group-hover:rounded-tr-full'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 md:w-[600px] gap-5 mt-4 md:mt-0'>
                    <div className='flex flex-col w-[280px] md:h-[600px] col-span-1'>
                        <Link
                            href={ROUTES.CATEGORIES_CONSTRUCTION}
                            className='group'
                        >
                            <div className='relative h-[280px] w-[280px] hidden md:block'>
                                <Image
                                    src={'/assets/images/categories/categories-4.jpg'}
                                    alt='Construction jobs in Australia with Insyncx'
                                    width={600} height={600}
                                    className='object-cover rounded-t-full w-full h-full'
                                />
                            </div>
                    ...
                    <div className='flex flex-col w-[280px] md:h-[600px] col-span-1'>
                        <Link href={ROUTES.CATEGORIES_CLEANING} className='group flex flex-col gap-5'>
                            <div className={`bg-orange rounded-full rounded-bl-none h-[280px] pl-14 pt-14 duration-500 group-hover:rounded-bl-full`}>
                            ...
                            <div className='relative h-[300px] w-[280px] hidden md:block'>
                                <Image
                                    src={'/assets/images/categories/cat-4.webp'}
                                    alt='Cleaning jobs in Australia with Insyncx'
                                    width={600}
                                    height={600}
                                    className='object-cover rounded-full rounded-tr-none w-full h-full'
                                />
                            </div>
                        </Link>
                    </div>
