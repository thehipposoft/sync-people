  ...
  return (
    <div className='md:h-screen flex justify-between items-center mx-auto max-w-[1250px] px-8 md:p-0 flex-wrap mt-16 md:mt-0'>
      <div className='md:w-1/2 flex flex-col justify-center gap-2'>
        <h1 className='font-semibold mb-6 md:mb-0'>What is a Digital Passport?</h1>
        <p className='text-[#798196] leading-6 md:pt-4 mb-4 md:mb-0'>
            ...
            Your Digital Passport is more than a resume: it's your ticket to the Australian working world. Tailored to your talents, the industry you want to work in and the job you dream of getting.
            <br/>
        </p>
