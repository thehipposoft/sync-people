  ...
  return (
    <div className='h-screen flex justify-between md:px-20 max-w-[1350px] mx-auto'>
      <div className='md:w-2/5 flex flex-col justify-center'>
        ...
        <div className='flex'><a href="/profile"><button className='md:mx-2 md:mt-8 text-[#8D78E0] border-[#5B24F2] border px-6 py-2 rounded-3xl'>Create a Profile</button></a></div>
      </div>
