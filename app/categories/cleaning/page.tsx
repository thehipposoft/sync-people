            ...
            <div className="my-20 flex flex-col md:flex-row gap-16 max-w-[80vw] md:max-w-none">
                ...
                <div className="flex flex-col gap-6">
                    <div className="relative w-[240px] md:w-[490px] h-[300px] md:h-[520px]">
                        <Image src={'/assets/images/categories/cat-4.webp'} alt="" fill  className="object-cover md:rounded-tl-[300px] rounded-tl-[120px] md:rounded-br-[300px] rounded-br-[120px]"/>
                    </div>
