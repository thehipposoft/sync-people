...
const WhyUs = () => {
  return (
    <div className='md:h-screen flex justify-between md:px-20 max-w-[1350px] mx-auto p-6 md:p-0 flex-wrap mt-6 md:mt-0'>
      <div className='md:w-2/5 flex flex-col justify-center'>
        <h1 className='font-bold mb-4 md:mb-0'>Why Us?</h1>
      ...
      <div className='flex justify-center items-center mx-auto md:mx-0'>
        <Image src={'/assets/images/whyus.png'} width={450} height={400} alt='' className='object-cover w-52 md:w-auto' />
      </div>
    </div>
  )
}
