                                    ...
                                    <div className={`flex gap-2 pt-4`}>
                                        ...
                                        <button className='h-full flex text-[#326B88] border-[#326B88] border rounded-md px-3 py-2 duration-500 cursor-pointer fav-button'>
                                            <svg width="25" height="25" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='pr-1'>
                                                <path d="M26.5834 7.51661C24.0274 4.96061 19.8826 4.96061 17.3266 7.51661C17.0114 7.83181 16.7378 8.17181 16.5002 8.52861C16.2626 8.17181 15.989 7.83181 15.6738 7.51741C13.1178 4.96141 8.973 4.96141 6.417 7.51741C3.861 10.0734 3.861 14.2182 6.417 16.7742L16.5002 26.8566L26.5834 16.7734C29.1394 14.2174 29.1394 10.0734 26.5834 7.51661Z" stroke="#326B88" strokeWidth="1.92" strokeMiterlimit="10" strokeLinecap="square"/>
                                            </svg>
                                            Add to Saved List
                                        </button>
                                    </div>
