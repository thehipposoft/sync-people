...
export const metadata: Metadata = {
    title: "Why Choose a Career in Tourism? | Insyncx",
    description: "Explore the benefits of starting a career in tourism. Learn about opportunities, growth potential, and why this industry is perfect for backpackers, students, and newcomers to Australia.",
    openGraph: {
        title: "Why Choose a Career in Tourism? | Insyncx",
        description: "Discover the advantages of working in the tourism industry. From flexibility to career growth, tourism offers great opportunities for newcomers in Australia.",
        url: "https://insyncx.com/categories/tourism",
        siteName: "Insyncx",
        images: [
        {
            url: "/og-image.png",
            width: 1200,
            height: 630,
            alt: "Tourism Careers in Australia",
        },
        ],
        locale: "en_AU",
        type: "article",
        ...
        <PublicLayout>
            <script type="application/ld+json">
                {JSON.stringify({
                    ...
                    "@type": "Article",
                    "headline": "Why Choose a Career in Tourism?",
                    "description": "Learn why tourism is a top career choice in Australia. Find out about opportunities, skills required, and why it suits backpackers, students, and immigrants.",
                    "author": {
                        "@type": "Organization",
                        "name": "Insyncx"
                    },
                    ...
                    "mainEntityOfPage": {
                        "@type": "WebPage",
                        "@id": "https://insyncx.com/categories/tourism"
                    },
